...
let regexPseudo = /^[^0-9](?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9\_]{6,}$/;
let regexFlickr = /^((http|ftp)s?:\/\/)?(www\.)?(flickr\.com\/)[\w\-\/\:]+(\.jpe?g\/?|\.img\/?|\.png\/?|\.gif\/?)$/i;
let regexBirth = /^[0-9]{2}[\-\/ ][0-9]{2}[\-\/ ][0-9]{4}$/i;
let regexCB16 = /^([0-9]{4}[\-\.\/ ]?){3}[0-9]{4}$/;
let regCbExpiration = /^(([0][\d]|[1][012])\/[\d]{2})$/;
