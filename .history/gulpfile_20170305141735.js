...
gulp.task('js', function () {
    ...
    var validate = validator('./src/data/walkindead.json')
    if (!validate.errors) {
...
gulp.task('default', ['browser-sync', 'css', 'js'], function () {
    gulp.watch("./src/sass/**/*.scss", ['css']); // watch permet de regarder les changements de fichier et lancer les tâches que l'on souhaite
